...
const baseModules = [
  ...
  { title: "Command Center", description: "Search, customer 360, AI signals, pipeline, receivables and warehouse intelligence.", path: "/command-center", icon: "✦", metric: "Decision intelligence", tone: "purple", roles: ["SALES", "SALES_MANAGER", "FINANCE"] },
];
...
export default function SalesDashboard() {
  ...
  return <div className="sales-page">
    <header className="sales-topbar"><Link to="/sales" className="sales-brand"><span className="sales-brand-mark">D</span><span><strong>DealFlow360</strong><small>Intelligent Sales Operations</small></span></Link><div className="sales-user"><div className="sales-user-copy"><strong>{user?.name || "Workspace user"}</strong><span>{roleLabel}</span></div><ProfileMenu /></div></header>
