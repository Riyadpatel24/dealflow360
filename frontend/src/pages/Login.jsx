    ...
    <div className="login-page">
      <section className="login-hero">
        ...
        <div className="login-features">
          <div className="login-feature">
            ...
            <div><strong>Policy-driven discounts</strong><span>Stay compliant, always</span></div>
          </div>
          <div className="login-feature">
            <div className="login-feature-icon">♧</div>
            <div><strong>Multi-level approvals</strong><span>Sales → Manager → Finance</span></div>
          </div>
          <div className="login-feature">
            <div className="login-feature-icon">⌁</div>
            <div><strong>Real-time risk evaluation</strong><span>Spot and mitigate risks early</span></div>
          </div>
          <div className="login-feature">
            <div className="login-feature-icon">ϟ</div>
            <div><strong>Faster deal closures</strong><span>From quotation to fulfillment</span></div>
          </div>
        </div>
      ...
      <section className="login-panel">
        <div className="login-card">
          ...
          <button type="button" className="google-button" onClick={() => setError("Google sign-in is not configured for this hackathon build.")}>
          ...
          <div className="login-demo">
            ...
            {DEMO_ACCOUNTS.map(([label, account]) => (
              <p key={label}><strong>{label}:</strong> {account}</p>
            ))}
          </div>
